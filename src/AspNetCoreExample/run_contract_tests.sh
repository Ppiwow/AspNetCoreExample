...
SC_CONTRACT_DOCKER_VERSION="${SC_CONTRACT_DOCKER_VERSION:-2.2.3.RELEASE}"
APP_IP="$( ./whats_my_ip.sh )"
APP_IP="host.docker.internal"
APP_PORT="${APP_PORT:-5000}"
ARTIFACTORY_PORT="${ARTIFACTORY_PORT:-8010}"
APPLICATION_BASE_URL="http://${APP_IP}:${APP_PORT}"
ARTIFACTORY_URL="http://${APP_IP}:${ARTIFACTORY_PORT}/artifactory/libs-release-local"
CURRENT_DIR="$( pwd )"
CURRENT_DIR="C:/git/ContractTestinAspNetCoreExample/src/AspNetCoreExample"
